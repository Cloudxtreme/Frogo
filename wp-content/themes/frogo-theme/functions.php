...
function generate_add_footer_info() {
  ?>
  <span class="copyright"><?php _e('Copyright', 'generate'); ?> &copy; <?php if (date('Y') == 2015): echo date('Y');
  else: echo '2015 - ' . date('Y');
  endif; ?></span> <?php do_action('generate_copyright_line'); ?>
  <?php
}
...
function generate_add_login_attribution() {
  ?>
  &#x000B7; Created for Frogo s.r.o. by Alexander Klepikov
  <?php
}
